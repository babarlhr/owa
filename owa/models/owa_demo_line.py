...
class OwaDemoLine(models.Model):
    _name = 'owa.demo.line'
    ...
    demo_id = fields.Many2one(string=_("Many2one"), comodel_name='owa.demo')
    one2many = fields.One2many(string=_("One2many"), comodel_name='owa.demo.line.line', inverse_name='demo_line_id')
